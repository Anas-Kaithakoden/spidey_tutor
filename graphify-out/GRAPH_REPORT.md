...
### Community 1 - "react"
Cohesion: 0.12
Nodes (27): ref_base_ui_react_button, ref_base_ui_react_merge_props, ref_base_ui_react_use_render, class-variance-authority, lucide-react, ref_next_link, ref_next_navigation, react (+19 more)
...
### Community 3 - "api.ts"
Cohesion: 0.08
Nodes (39): AddMaterial(), handleContinue(), isYoutubeUrl(), ExamResults(), Notes(), handleGenerate(), Preview(), ProgressDashboard() (+31 more)
...
Cohesion: 0.06
Nodes (41): _build_eval_prompt(), _build_generation_prompt(), _coerce_status(), _display_answer(), _error_detail(), evaluate_exam(), _expected_display(), generate_exam() (+33 more)

### Community 11 - "openai_compat.py"
Cohesion: 0.21
Nodes (17): chat_completion(), chat_json(), chat_text(), CompatConfig, _extract_json(), generate_chat_reply(), generate_flashcards(), generate_quiz() (+9 more)

### Community 12 - "TranscriptRetrievalTests"
Cohesion: 0.25
Nodes (4): FakeSnippet, FakeTranscript, FakeTranscriptList, TranscriptRetrievalTests
...
### Community 16 - "ai.py"
Cohesion: 0.14
Nodes (14): _error_detail(), generate_flashcards(), generate_quiz(), generate_study_notes(), _normalize_flashcard(), _normalize_question(), _normalize_study_notes(), Exception (+6 more)
...
Cohesion: 0.11
Nodes (31): ref_base_ui_react_input, ref_base_ui_react_switch, cn, difficulties, durationOptions, ExamSetup(), handleStart(), questionCounts (+23 more)
...
Cohesion: 0.11
Nodes (22): _build_script_prompt(), Line, max_words_for(), min_lines_for(), min_words_for(), _mock_script(), Any, BaseModel (+14 more)
...
Cohesion: 0.12
Nodes (11): ref_base_ui_react_progress, AnswerState, ExamScreen(), mapAnswers(), readStored(), storageKey(), StoredAnswers, TYPE_LABELS (+3 more)
...
Cohesion: 0.13
Nodes (17): MODE_SHORT, PodcastPage(), handleDelete(), readEpisodeId(), formatTime(), MODE_LABELS, PodcastPlayer(), retryAudio() (+9 more)

### Community 50 - "test_exams.py"
Cohesion: 0.16
Nodes (6): ExamOutSchemaTests, GenerationTests, pathlib, sys, tempfile, unittest
...
Cohesion: 0.18
Nodes (14): _client(), generate_chat_reply_raw(), generate_flashcards_raw(), generate_json(), generate_quiz_raw(), generate_study_notes_raw(), Call Gemini and return raw study-notes dict (no normalization)., Call Gemini and return a grounded answer to the last user message. ``history``… (+6 more)

### Community 58 - "ollama.py"
Cohesion: 0.22
Nodes (14): available_models(), _chat_json(), _chat_text(), generate_chat_reply(), generate_flashcards(), generate_json(), generate_quiz(), generate_study_notes() (+6 more)
...
Cohesion: 0.27
Nodes (13): _cfg(), generate_chat_reply(), generate_flashcards(), generate_json(), generate_quiz(), generate_study_notes(), list_models(), _model() (+5 more)

### Community 62 - "transcript.py"
Cohesion: 0.19
...
### Community 65 - "ProviderError"
Cohesion: 0.18
Nodes (10): _badge_error(), _error_message(), ProviderError, A provider request failed. ``user_message`` is a safe, end-user-friendly reason…, Best-effort human-readable message from an API error body., Map an HTTP status to a useful, user-facing ProviderError., _error_detail(), Exception (+2 more)

### Community 66 - "QuickGenerationTests"
Cohesion: 0.20
Nodes (3): _assert_alternation(), object, QuickGenerationTests

### Community 67 - "test_providers.py"
Cohesion: 0.28
Nodes (4): Settings, EnvConfigTests, ModelRegistrationTests, BaseSettings

### Community 68 - "CreatePodcast"
Cohesion: 0.32
Nodes (3): CreatePodcast, field_validator, CreatePodcastSchemaTests

### Community 71 - "test_youtube_ingestion.py"
Cohesion: 0.50
Nodes (3): contextlib, fastapi_testclient, sqlalchemy_pool
...
- **Why does `Material` connect `Material` to `study_notes.py`, `models.py`, `materials.py`, `youtube.py`, `flashcards.py`, `main.py`, `ExamApiTests`, `test_exams.py`, `exams.py`, `services/audio.py`, `PodcastApiTests`, `chat.py`, `schemas.py`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `FailureFallbackTests` connect `object` to `test_providers.py`?**
